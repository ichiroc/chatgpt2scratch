...
sed -e "s/process.env.DOJO_KEY/${DOJO_KEY}/g" ./scratch-vm/src/extensions/scratch3_chatgpt2scratch/index.js > ./scratch-vm/src/extensions/scratch3_chatgpt2scratch/index.js
